...
import ConsultationsForm from "./components/pages/consultations/consultationForms/ConsultationsForm";
import ConsultationDetails from "./components/pages/consultations/recordDetails/ConsultationDetails";
